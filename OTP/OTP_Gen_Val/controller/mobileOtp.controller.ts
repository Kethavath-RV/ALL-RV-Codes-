...
//Otp Generation
export let createOtpTrasactionForMobile = async (req:Request, res:Response)=>{
    try{
...
//Otp Validation
export let otpValidationForMobile = async (req:Request, res:Response)=>{
    try{
        let mobileNumber = req.body.mobileNumber;
        ...
        if(decryptedInfo.mobileNumber == mobileNumber){
