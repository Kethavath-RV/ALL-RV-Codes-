...
function sendEmail(email, otp, subject, url) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, filePathText, source, template, replacements, htmlToSend, transporter, mailOptions, info;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = path.join(__dirname, '../../Email_Template/emailTemplates.html');
                    filePathText = path.join(__dirname, '../../Email_Template/test.txt');
                    source = fs.readFileSync(filePathText, 'utf-8').toString();
