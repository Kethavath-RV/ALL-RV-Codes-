...
function sendEmail(email, otp, expiryTime) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, source, template, time, replacements, htmlToSend, transporter, mailOptions, info;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = path.join(__dirname, '../../Templates/emailTemplates.html');
