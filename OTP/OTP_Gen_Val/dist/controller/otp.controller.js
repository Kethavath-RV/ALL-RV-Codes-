...
exports.validation = exports.createOtpTrasaction = void 0;
...
//Otp Generation
var createOtpTrasaction = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var emailId, mobileNumber, otp, i, currentTime, expiryTime, otpTransaction, createdOtpTransaction, b, info, encryptedInfo, err_1;
...
exports.createOtpTrasaction = createOtpTrasaction;
//Otp Validation
var validation = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var emailId, mobileNumber, otp_1, encryptedData, decryptedData, decryptedInfo_1, otpInfo_1, noOfAttempts, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (!(decryptedInfo_1.email == emailId || decryptedInfo_1.mobileNumber == mobileNumber)) return [3 /*break*/, 3];
