...
exports.otpValidationForEmail = exports.createOtpTrasactionForEmail = void 0;
var otp_model_1 = __importDefault(require("../model/otp.model"));
var otpRsaService1 = __importStar(require("../service/otp_rsa1.service"));
var EmailOtp = __importStar(require("../service/sendEmail.service"));
var config = __importStar(require("../config/config"));
//Otp Generation
var createOtpTrasactionForEmail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var emailId, otp, i, currentTime, expiryTime, otpTransaction, createdOtpTransaction, info, encryptedData, err_1;
...
exports.createOtpTrasactionForEmail = createOtpTrasactionForEmail;
//Otp Validation
var otpValidationForEmail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var emailId, otp_1, encryptedData, decryptedData, decryptedInfo_1, otpInfo_1, noOfAttempts, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (!(decryptedInfo_1.email == emailId)) return [3 /*break*/, 3];
...
exports.otpValidationForEmail = otpValidationForEmail;
